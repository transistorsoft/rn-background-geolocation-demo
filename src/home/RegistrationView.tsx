    ...
    return (
      <Container style={styles.container}>
        <Header style={styles.header}>
          ...
          <Right>
            <Button transparent onPress={this.onClickRegister.bind(this)}><Text style={styles.title}>REGISTER</Text></Button>
          </Right>
        </Header>

        <Content style={styles.content}>
          <Text style={styles.bodyText}>Please provide a unique Organization and User identifier to register your device with the Demo Server.</Text>

          <Text style={styles.bodyText}>You will access your results at the following url:</Text>
          ...
          <FormItem error={!this.state.usernameIsValid} stackedLabel key="username" style={styles.formItem}>
            <Label style={styles.formLabel}>User identifier</Label>
            <Input
              style={styles.input}
